...
(C) “Closerrr,” “We,” “Us,” or “Company”<br />
Refers to Closerrr Interactive Private Limited, its subsidiaries, affiliates, successors, and assigns, including all platforms, services, and intellectual property it owns or operates.<br />
(D) “Content”<br />
Means all forms of data, information, messages, images, audio, video, media, text, emojis, links, documents, metadata, or other material—whether posted, shared, transmitted, recorded, downloaded, or stored—by Users, Friends, or the Platform itself.<br />
(E) “Device”<br />
Means any mobile phone, tablet, computer, or other electronic device used to access the Platform or Services.<br />
(F) “Dispute”<br />
Shall refer to any claim, controversy, cause of action, or legal disagreement arising out of, or relating to, the Terms, Services, or any conduct of the parties governed by this Agreement.<br />
(G) “Effective Date”<br />
Means the date on which these Terms were last updated, as specified at the end of this document.<br />
(H) “Friend”<br />
Refers to a verified individual on Closerrr who shares content, interacts with Subscribers, and avails the Platform's services in a creator, celebrity, influencer, artist, or public figure capacity. All content shared by a Friend remains their sole intellectual property.<br />
(I) “Intellectual Property Rights”<br />
Means all rights arising under patent law, copyright law, trademark law, design law, trade secret law, and any and all other proprietary rights, including but not limited to moral rights, privacy rights, publicity rights, and database rights, under any applicable legal system.<br />
(J) “Personal Data”<br />
Means any data that directly or indirectly identifies an individual, including but not limited to name, phone number, email address, IP address, geolocation data, payment information, or other identifiers, as further described in the Privacy Policy.<br />
(K) “Platform”<br />
Means the Closerrr mobile application, website, associated APIs, backend infrastructure, and all digital properties operated or controlled by the Company.<br />
(L) “Services”<br />
Means all features, functionalities, products, subscriptions, communications, interactions, support systems, and related offerings made available through the Platform.<br />
(M) “App”<br />
Means the Closerrr mobile application available for download on authorized digital storefronts, including but not limited to the Apple App Store and Google Play Store, together with all associated updates, software code, user interfaces, content, and documentation provided by Closerrr.<br />
(N) “Subscriber”<br />
Refers to a registered user who subscribes to a Friend, purchases access to their content, or interacts with the Platform through paid or unpaid means.<br />
(O) “Subscription”<br />
Means a time-bound access to a Friend’s content or features made available on the Platform in exchange for a recurring fee, subject to the Subscription & Payment terms outlined herein.<br />
(P) “Terms” or “Terms and Conditions”<br />
...
(c) You represent and warrant that you own or have obtained all necessary licenses, rights, consents, and permissions to grant the foregoing license and that the exercise of such rights by the Company will not infringe, misappropriate, or violate any third-party rights, including but not limited to intellectual property, privacy, or publicity rights.</p>
<p>(B) Company Intellectual Property and Proprietary Rights<br />
(a) All rights, title, and interest in and to the Platform, the Services, and all associated software, code, compilations, databases, content, information, functionality, designs, graphical interfaces, logos, branding, trademarks, service marks, trade dress, audiovisual elements, and other materials created, owned, or provided by the Company (“Company Materials”) are and shall remain the sole and exclusive property of the Company and/or its licensors, protected by applicable copyright, trademark, trade secret, and other intellectual property laws.<br />
(b) Except as expressly authorized by the Company in writing, you shall not, and shall not attempt to, directly or indirectly:<br />
(i) copy, download, reproduce, modify, adapt, translate, create derivative works from, distribute, sell, license, publicly perform or display, republish, reverse engineer, decompile, disassemble, or otherwise exploit the Company Materials;<br />
...
<p>(a) The Company may transfer your Personal Data to recipients located in countries outside of your jurisdiction for purposes consistent with the Privacy Policy, including without limitation to facilitate operations, cloud storage, data processing, analytics, or compliance activities.<br />
(b) Where required by Applicable Law, Closerrr shall implement legally recognized safeguards to ensure adequate protection of Personal Data during such transfers, which may include the use of standard contractual clauses or other legally approved mechanisms.</p>
<p>(C) Data Localization Requirements</p>
<p>(a) In jurisdictions where Applicable Law mandates the localization of certain categories of data (including but not limited to payment data, communications data, or government-identified data), Closerrr shall comply with such requirements by storing and processing such data within the required territorial boundaries or through licensed data localization partners.<br />
(b) Users shall not engage in any activity intended to circumvent data localization obligations imposed under applicable national laws, and Closerrr reserves the right to suspend or restrict Services in case of non-compliance.</p>
<p>(D) Retention and Processing</p>
<p>(a) Personal Data collected by the Company shall be retained for such duration as is necessary to fulfil the purposes for which it was collected, or as required by applicable legal, regulatory, tax, or accounting obligations.<br />
...
<p>(a) A clear identification of the copyrighted work or material claimed to have been infringed, or if multiple works are involved, a representative list of such works;<br />
(b) A specific identification of the material you believe is infringing, including the location (e.g., specific URL or in-app location) sufficient to permit us to locate the material;<br />
(c) Your full legal name, physical address, telephone number, and a valid email address;<br />
(d) A statement that you have a good faith belief that the disputed use is not authorized by the copyright owner, its agent, or the law;<br />
(e) A statement that the information provided in the notice is accurate, and under penalty of perjury, that you are the owner or are authorized to act on behalf of the owner of the copyright or other intellectual property interest being infringed;<br />
...
<p>(a) Temporarily or permanently remove or disable access to the allegedly infringing content;<br />
(b) Notify the content uploader, where applicable, of the complaint and provide an opportunity to respond or file a counter-notification, where legally permitted;<br />
(c) Terminate or restrict access to repeat infringers or Users who violate these Terms or applicable intellectual property laws.</p>
...
<p>(a) Your name, address, phone number, and email address;<br />
(b) Identification of the removed content and the location at which it appeared before removal;<br />
(c) A statement, under penalty of perjury, that you have a good faith belief the content was removed or disabled as a result of mistake or misidentification;<br />
(d) A statement consenting to the jurisdiction of courts in Bhopal, Madhya Pradesh, and that you will accept service of process from the complainant or their authorized agent;<br />
(e) Your physical or electronic signature.</p>
...
(a) As a condition precedent to the initiation of any formal legal proceeding, you agree to engage in good-faith efforts to resolve any controversy, dispute, claim, or disagreement arising out of or relating to these Terms, your use of the Services, or any act or omission of the Company (collectively, a “Dispute”) through informal negotiations, commencing upon written notice from one party to the other. Upon receipt of such notice, both parties shall use reasonable efforts to resolve the Dispute amicably.<br />
(b) If a resolution is not achieved through informal negotiation, all disputes shall be submitted to the exclusive jurisdiction of the courts in Bhopal, Madhya Pradesh.<br />
...
<p>(B) User Communication Preferences<br />
By accessing or using the Platform, you consent to receive communications from the Company electronically, including but not limited to administrative messages, account-related information, promotional materials, policy updates, and legal notices. Such communications may be delivered via in-app notifications, emails, text messages, or push notifications, as determined appropriate by the Company.<br />
You acknowledge that opting out of certain types of communications may limit your ability to access full features of the Services or receive critical updates. The Company shall not be held liable for any loss or limitation resulting therefrom.</p>
<p>(C) Deemed Receipt of Notices<br />
Any notice or communication sent by the Company shall be deemed to have been duly received and read:<br />
(a) Immediately upon successful transmission, if delivered via in-app notification or email;<br />
(b) Within 72 (seventy-two) hours of dispatch, if delivered to the last known contact details associated with your Account, unless a delivery failure notice is received;<br />
(c) At the time of posting, if published on any official Platform interface, including banners, pop-ups, or helpdesk communications.<br />
It shall be your sole responsibility to ensure that your contact details registered with the Platform are accurate, current, and capable of receiving official correspondence. The Company disclaims all responsibility for communications not received due to outdated or incorrect contact information.</p>
<p>(D) Language of Communication<br />
...
<p>(B) Amendments and Modifications<br />
(a) Closerrr reserves the sole right to update, modify, or replace any part of these Terms at any time, in accordance with the procedures outlined in Section 11 (“Changes to the Services & Updates to Terms”).<br />
(b) Continued use of the Services following such modifications shall constitute binding acceptance of the revised Terms.</p>
<p>(C) Severability<br />
...
<p>(B) Export and Technology Control Compliance<br />
(a) The App, Platform, and Services may be subject to export control laws and regulations of India, the United States, or other relevant jurisdictions. You agree not to export, re-export, or transfer any portion of the Services or related technology in violation of such laws.<br />
...
<p>(B) Language and Ambiguities<br />
(a) These Terms shall be interpreted fairly and reasonably, and not strictly for or against either party, regardless of authorship or drafting responsibility.<br />
(b) In the event of any ambiguity or uncertainty in the interpretation of any provision of these Terms, such provision shall be construed in a manner consistent with the overall purpose and intent of this Agreement.</p>
<p>(C) Plural and Gender Usage<br />
Unless otherwise indicated by context:<br />
(a) Words importing the singular include the plural and vice versa;<br />
(b) Words importing a specific gender shall be deemed to include all genders and non-binary identities;<br />
...
<p>(B) License Grant for Public Content<br />
(a) By using the Services, you grant Closerrr a worldwide, royalty-free, non-exclusive, transferable, sublicensable license to use, reproduce, modify, publish, translate, publicly display, and distribute public content you have made available through the Platform for promotional purposes.<br />
(b) This license is limited to non-private content and does not extend to private messages, personal data, or restricted-access material unless separately consented to or permitted by law.</p>
...
(b) Users acknowledge that their continued access to the Services is conditioned upon their understanding and acceptance of the English version of these Terms.</p>
<p>(C) User Responsibility<br />
Users who are not proficient in English are solely responsible for seeking assistance, translation, or legal consultation to ensure full comprehension prior to accepting or relying on these Terms.</p>
`;
    ...
    <div className="bg-secondary-500 min-h-screen">
      <div className="px-4 sm:px-8 lg:px-32 py-10 sm:py-20 flex items-center flex-col w-full">
        <h1 className="text-3xl sm:text-4xl lg:text-[2.5rem] xl:text-creator-heading-lg text-center text-customPink-500 mt-10 sm:mt-20 font-hellix-bold">
          <span className="font-fredoka text-customPurple-500">Closerrr</span> Terms & Conditions
        </h1>
        <div
