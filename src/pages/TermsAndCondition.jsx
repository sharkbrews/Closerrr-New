  ...
  return (
    <div className="bg-secondary-500">
      <div className="  px-8 lg:px-32 pt-40 flex items-center flex-col w-full">
        ...
        <div
          className="font-hellix-medium terms-content text-[1.5rem] leading-[2.5rem] text-[#4B164C] mt-10"
          dangerouslySetInnerHTML={{ __html: htmlContent }}
        />
      </div>
      <motion.div
        className="w-full min-h-[16vw] flex justify-center pb-16"
      ...
      >
        <motion.img
          className="md:w-fit md:h-fit w-[30vw] mt-16"
          src="/Group-end.svg"
          alt=""
          initial={{ scale: 0.8 }}
          whileInView={{ scale: 1 }}
