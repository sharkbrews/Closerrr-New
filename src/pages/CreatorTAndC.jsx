...
(ii) Expansion to other jurisdictions may occur at a later date, subject to business and regulatory feasibility.<br />
(b) Age Requirement<br />
(i) You must be at least eighteen (18) years of age to apply as a Creator.<br />
...
(b) Preliminary Vetting<br />
(i) Closerrr may assess your public presence, social media profiles, prior content, and engagement style to determine suitability.<br />
(ii) We reserve the right to conduct independent due diligence or request supplementary information, clarification, or a virtual onboarding interview prior to issuing a decision.<br />
...
(c) Closerrr retains absolute discretion in determining whether an applicant satisfies its internal eligibility, reach, or suitability criteria and may reject or rescind access at any stage.</p>
<p>(B) Pre-Approval Evaluation Process<br />
(a) Applicants must submit accurate contact information, including links to verified social profiles (e.g., Instagram).<br />
(b) If shortlisted, Closerrr will issue a conditional selection email outlining the remaining onboarding steps, including verification, identity checks, and account information requirements.<br />
(c) Any misrepresentation or failure to comply with onboarding instructions may result in delays or rejection of your application. However, unless explicitly barred by Closerrr, you may re-initiate the process by submitting a fresh Creator interest form through the official website.</p>
<p>(C) Identity & Consent Verification<br />
(a) To finalize onboarding, the Creator must:<br />
(i) Confirm the email ID they wish to use for their Closerrr Creator Account;<br />
(ii) Provide their full name to be displayed across public-facing modules including the explore profile, showcase profile, and official subscription invoice;<br />
(iii) Submit a verification message from their public or most-followed Instagram handle in the prescribed format to confirm both identity and consent.<br />
(b) Closerrr reserves the right to authenticate the Instagram profile, validate public presence, and retain the verification message for audit purposes.<br />
(c) Links to the Closerrr Creator Terms & Conditions and Privacy Policy will be provided during this step, and acceptance of both shall be deemed confirmed upon submission of the verification message.</p>
<p>(D) Account Creation and Activation<br />
(a) Upon successful completion of all onboarding steps, Closerrr will generate a Creator Account and send login credentials to the email address confirmed by the Creator.<br />
(b) The Creator shall be instructed to change their temporary password at first login via the procedure outlined in the onboarding email.<br />
(c) No Creator rights, visibility, or monetization privileges shall vest until Closerrr confirms successful activation of the account.</p>
<p>(E) Ongoing Obligations & Account Management<br />
(a) Creators must keep their account credentials confidential and shall be solely responsible for any activity conducted under their profile.<br />
(b) Creators are required to notify Closerrr of any unauthorized access, technical issue, or compromise to their account promptly.<br />
(c) Closerrr may, at its discretion, initiate periodic re-verification or request updated profile information to maintain account validity and public trust.<br />
(d) Creators shall not attempt to create multiple accounts or impersonate another person, public figure, or entity.</p>
...
(c) Infringes on any third party’s intellectual property or publicity rights, including:<br />
(i) Copyrighted or trademarked material without proper authorization<br />
(d) Discloses personally identifiable information or private data of any individual without lawful consent<br />
(e) Constitutes spam, click-bait, pyramid schemes, or unsolicited promotions<br />
(f) Contains viruses, trojans, or malicious code intended to disrupt system integrity<br />
...
(iii) Tier 3: With 2,000–2,999 active Subscribers, you will earn 72% (Closerrr retains 28%).<br />
...
(c) Circumvent, disable, or otherwise interfere with security-related features or usage limits imposed by the Platform;<br />
...
(c) Closerrr shall bear no liability for any penalties, consequences, or legal actions resulting from your failure to fulfill your tax, registration, or reporting obligations.<br />
(d) You acknowledge and agree that you are operating on the Platform as an independent contractor, and not as an employee, agent, joint-venturer, or partner of Closerrr. Accordingly, you are not entitled to any employment-related benefits, reimbursements, or legal protections afforded to salaried personnel.<br />
(e) You are solely responsible for the accurate calculation, reporting, and timely payment of all applicable taxes on your income earned through Closerrr, including but not limited to income tax, professional tax, or other levies mandated under Applicable Law. Closerrr does not provide tax advice and disclaims all liability arising from your personal or business tax obligations.</p>
<p>(B) Banking & Identification Requirements<br />
(a) You must provide valid, active, and accurate Indian bank account information registered under your legal name or authorized entity in order to receive Payouts.<br />
(b) Closerrr reserves the right to withhold Payouts or suspend accounts where the submitted banking or tax information is unverifiable, inconsistent, or non-compliant.<br />
(c) You agree to promptly update your account information in the event of any change in your legal name or banking credentials.</p>
<p>(C) GST Compliance (if applicable)<br />
(a) If you are registered under the Goods and Services Tax (GST) regime in India, you must furnish your valid GSTIN to Closerrr for invoicing and compliance purposes.<br />
(b) You are responsible for issuing necessary tax invoices, if required, and for remitting the applicable GST amount to the tax authorities in accordance with prevailing law.<br />
(c) Closerrr shall not be responsible for the reconciliation, collection, or payment of GST on your behalf, and you agree to indemnify Closerrr for any loss, liability, or proceeding arising out of your non-compliance.</p>
<p>(D) Withholding Taxes & Statutory Deductions<br />
(a) Closerrr reserves the right to deduct or withhold applicable taxes at source (TDS) on Creator Payouts as required under the Income Tax Act, 1961 or any successor legislation.<br />
(b) Closerrr shall issue TDS certificates or equivalent documentation as required by law and will remit such withheld taxes to the appropriate authorities.</p>
...
(b) Internal documentation, policies, creator analytics, platform usage data, revenue insights, business plans, financial data, subscriber demographics, and proprietary technology of Closerrr;<br />
(c) Any correspondence or communication from Closerrr's staff, support, operations, moderation, or legal teams.</p>
<p>(B) Non-Disclosure Obligations<br />
(a) You agree not to disclose, share, reproduce, or use any Confidential Information for any purpose other than as expressly permitted under these Terms or as required to comply with Applicable Law.<br />
(b) You shall exercise at least the same degree of care you use to protect your own confidential information (but in no event less than reasonable care) to protect the confidentiality and integrity of Closerrr’s Confidential Information.<br />
(c) You shall not disclose Confidential Information to any third party without Closerrr’s prior written consent, except to your legal or financial advisors who are bound by equivalent confidentiality obligations.<br />
(d) You are expressly prohibited from publicly demonstrating, disclosing, or discussing the internal workings, structure, user interface, or operational flow of any Creator-exclusive features on the Platform — including but not limited to dashboard or payouts layouts, content publishing tools, analytics views, support features, or app configurations intended solely for Creator use — whether through screenshots, screen recordings, verbal descriptions, written walkthroughs, or any other medium, without Closerrr’s prior written authorization.<br />
(e) You agree not to publicly share, publish, or otherwise disclose your earnings from Closerrr — including payout amounts, commission rates, revenue tiers, or subscriber count metrics — unless explicitly authorized in writing by Closerrr. This includes posts on social media, interviews, third-party platforms, or private groups.</p>
<p>(C) Exclusions<br />
The obligations in this Section shall not apply to information that:<br />
(a) Was already lawfully known to you prior to disclosure;<br />
(b) Is or becomes publicly known through no fault of your own;<br />
(c) Is rightfully obtained by you from a third party without breach of any confidentiality obligation; or<br />
(d) Is independently developed by you without use of or reference to Closerrr’s Confidential Information.</p>
<p>(D) Compelled Disclosure<br />
...
(c) Spam, mass-message, or otherwise abuse Platform communication features;<br />
(d) Attempt to scrape, collect, or mine Subscriber data, including usernames or personal details, for off-platform use or resale;<br />
(e) Divert Closerrr users to competing platforms, paid services, or external channels without express authorization from Closerrr;<br />
...
(ii) Email-based complaints directed to our official support team at creatorcare@closerrr.com;<br />
(iii) Internal flags raised by Closerrr moderators or automated monitoring systems.</p>
...
<p>(B) Platform Moderation Authority<br />
(a) Closerrr retains the sole and absolute discretion to investigate any suspected violation of these Terms, Community Guidelines, or Applicable Law.<br />
(b) Investigations may include review of chat logs, content metadata, Creator activity records, or Subscriber complaints, and may be conducted with or without prior notice to the Creator.<br />
(c) Closerrr is not obligated to disclose the identity of a complainant unless legally required to do so.</p>
<p>(C) Types of Violations Subject to Enforcement<br />
Enforcement action may be initiated for, but is not limited to:<br />
(i) Repeated or egregious violations of the Prohibited Conduct outlined in Section 13 (Prohibited Conduct);<br />
(ii) Attempts to evade suspension or policy enforcement by using alternative accounts or proxies;<br />
(iii) Use of the Platform to defraud, exploit, or harm Subscribers;<br />
(iv) Breach of confidentiality obligations or unauthorized disclosure of Platform information;<br />
(v) Non-cooperation during a compliance review, audit, or investigation.</p>
<p>(D) Enforcement Measures<br />
Closerrr may, at its sole discretion, impose one or more of the following:<br />
(i) Warnings or written reprimands;<br />
(ii) Temporary suspension of Creator Account access or monetization tools;<br />
(iii) Permanent termination of the Creator Account;<br />
(iv) Withholding or forfeiture of Payouts (as per Section 6 (Earnings, Revenue Share & Payouts) and Section 15 (Account Suspension, Termination & Withdrawal));<br />
(v) Blacklisting from future Creator onboarding eligibility.</p>
<p>(E) No Obligation to Disclose Outcomes<br />
Closerrr is not obligated to disclose the internal rationale, findings, or exact outcome of any enforcement decision. Closerrr may, at its discretion, share high-level summaries or generic reasons to maintain platform integrity and fairness.</p>
<p>(F) No Obligation to Mediate<br />
...
(b) You engage in conduct that, in Closerrr’s sole judgment, is abusive, fraudulent, unlawful, or harmful to the Platform’s reputation or its users.<br />
(c) You are subject to investigation based on a credible report of misconduct or breach.<br />
(d) You are inactive on the Platform for an extended period of time without prior communication.<br />
(e) You fail to respond to compliance requests, verification requirements, or reasonable communications from Closerrr’s support or legal teams.<br />
(f) Your behavior threatens the operational integrity, safety, or brand value of the Platform.</p>
<p>(B) Suspension Procedure<br />
(a) Closerrr may impose a temporary Suspension while an investigation is ongoing. During Suspension, you may lose access to certain Platform features or to your entire Creator Account.<br />
(b) Suspended accounts do not receive Payouts until the issue is resolved.<br />
(c) Depending on the outcome, Closerrr may lift the Suspension, escalate to Termination, or impose remedial measures including warnings, feature limitations, or payout adjustments.</p>
<p>(C) Permanent Termination<br />
(a) Termination is a final and irreversible action that permanently disables your Creator Account and access to all Closerrr features.<br />
(b) All Payouts for the month in which Termination occurs shall be forfeited as a contractual penalty, except where otherwise required by law or explicitly permitted by Closerrr.<br />
(c) Termination may be accompanied by blacklisting of your personal identifiers (e.g., email, device ID, payment credentials) to prevent future re-registration.</p>
<p>(D) Voluntary Withdrawal by Creator<br />
(a) You may request the termination and deactivation of your Creator Account by contacting support via your registered email.<br />
(b) Your voluntary withdrawal is subject to the same financial consequences as a Termination. As per Section 15(C)(b), you will forfeit all Payouts accrued during the calendar month in which you submit your withdrawal request.<br />
(c) Any cleared Payouts from previous, completed revenue cycles will still be processed on the normal Payout Schedule, provided your account is not subject to any other holds.</p>
...
<p>(E) Data Retention & Deletion<br />
(a) Upon Suspension or Termination, your Content may be retained in a limited capacity for audit, compliance, and archival purposes as governed by Section 17 (Data Privacy & Security Commitments).<br />
(b) Certain metadata, chat logs, or analytics may be anonymized and preserved in accordance with Applicable Law.</p>
<p>(F) Non-Refundability & No Liability<br />
(a) No refunds shall be issued to you or your Subscribers for any portion of a billing cycle during which Suspension or Termination occurs.<br />
(b) You acknowledge that Closerrr bears no liability for loss of income, audience, access, or goodwill resulting from enforcement actions under this Section.</p>
...
<p>(b) You agree to cooperate in good faith with Closerrr’s dispute resolution process, which may include providing documentation, context, or clarifications upon request.</p>
<p>(c) The decision to uphold or deny a Subscriber dispute — including decisions related to refund processing or content removal — lies solely with Closerrr and shall be final.</p>
...
<p>(B) Creator Responsibilities in Handling Subscriber Data<br />
(a) You may be granted limited access to certain Subscriber interactions or identifiers strictly for the purposes of content delivery, messaging, or live sessions.<br />
(b) You shall not download, store, misuse, disclose, or retain any personal or sensitive Subscriber information outside the boundaries of the Platform.<br />
(c) Under no circumstances shall you request, solicit, or collect a Subscriber’s personal data (including but not limited to contact information, location, bank details, or identity documents) through any on-platform or off-platform means.<br />
(d) All Subscriber engagement shall be conducted exclusively through official Platform tools and interfaces. Any attempt to circumvent these safeguards shall constitute a material breach of these Terms.</p>
...
<p>(C) Information Security Measures<br />
(a) Closerrr implements industry-standard security measures to protect Creator data from unauthorized access, misuse, loss, or alteration.<br />
(b) While Closerrr undertakes reasonable efforts to ensure system integrity, you acknowledge and agree that no platform can guarantee absolute security and you assume appropriate caution in sharing information within your account.</p>
<p>(D) Breach Notification and Mitigation<br />
(a) In the event of a suspected or confirmed data breach involving your Creator Account, you must immediately notify Closerrr at the official support email.<br />
(b) You agree to cooperate with any investigation and undertake remedial actions as instructed by Closerrr, including but not limited to password resets, account lockdowns, or data access reviews.</p>
<p>(E) Consent to Cross-Border Transfers<br />
You acknowledge and consent that your data may be processed, stored, or transferred across jurisdictions, including to countries with different levels of data protection than India. By using the Platform, you provide express consent to such transfers, consistent with the Closerrr Creator Privacy Policy.</p>
...
<p>(B) No Responsibility for External Failures<br />
(a) Closerrr shall not be held liable for delays, disruptions, or failures in Platform performance resulting from the malfunction, downtime, or discontinuation of any integrated third-party service.<br />
(b) These dependencies may include (but are not limited to): OTP delivery providers, CDN networks, livestream backend processors, payment disbursal APIs, and device-level OS updates affecting app behavior.<br />
(c) Closerrr does not guarantee uninterrupted access to such services and reserves the right to modify or replace external dependencies at its sole discretion.</p>
<p>(C) Your Obligations Regarding Linked Accounts<br />
(a) In cases where you link or integrate any external account (e.g., bank portals, email services, or content libraries) with the Platform, you represent that you have the legal authority to do so and assume all responsibility for any data accessed or actions taken through such links.<br />
...
(c) You agree not to reproduce, adapt, display, or commercially exploit any part of the Platform without prior written consent from Closerrr.</p>
...
<p>(B) Use of Closerrr Trademarks & Branding<br />
(a) Except as expressly permitted by the limited license in subsection (c) below, you may not use the Closerrr name, logo, brand elements, trademarks, or service marks (collectively, “Brand Assets”) in any public-facing communication, marketing, merchandise, profile bio, or third-party content without receiving prior written approval from Closerrr.<br />
(b) Approved usage of Brand Assets must follow the official Closerrr Brand Guidelines, if made available. Any deviation may result in immediate withdrawal of usage rights.</p>
...
(d) Unauthorized or misleading association with the Closerrr brand — including endorsements, partnerships, or sponsorships that have not been explicitly approved — constitutes a material breach of these Terms.</p>
<p>(C) Creator Content Ownership<br />
(a) As set forth in Section 8 (Content Ownership & Licensing to Closerrr), you retain ownership of all original content created and uploaded by you on the Platform.<br />
(b) However, by using the Platform, you grant Closerrr a license to use your content in accordance with the terms of Section 8 (Content Ownership & Licensing to Closerrr).</p>
<p>(D) Infringement Reporting & IP Protection<br />
(a) If you believe that your copyrighted work, trademark, or other intellectual property has been used or published on the Platform without proper authorization, you may report such instances to Closerrr by contacting our support team via the official email with a detailed notice. Closerrr will evaluate such complaints in accordance with its internal takedown procedure and applicable legal standards.<br />
(b) You acknowledge that Closerrr may, at its discretion, remove allegedly infringing content or suspend the associated Creator Account pending review.</p>
...
<p>(d) The submission of a false or malicious IP claim may itself result in enforcement action, including legal liability or Termination of the reporting party’s account.</p>
<p>(E) No License by Implication<br />
Except as expressly provided in these Terms, no license, right, or interest is granted to the Creator by implication, estoppel, or otherwise in or under any patent, trademark, copyright, or other intellectual property of Closerrr.</p>
...
(b) Any Content you upload, publish, transmit, or distribute via the Platform;<br />
(c) Your breach or alleged breach of any representation, warranty, or obligation under these Terms;<br />
(d) Your violation of any Applicable Law, rule, regulation, or third-party right, including without limitation any intellectual property, privacy, publicity, or contractual rights;<br />
(e) Any disputes between you and any Subscriber, or between you and any third party arising from your conduct on or in connection with the Platform.</p>
<p>(B) Notification and Cooperation<br />
In the event of a claim for which Closerrr seeks indemnification under this section, we shall provide you with reasonably prompt written notice. You shall cooperate fully in the defense and resolution of such claims. Closerrr reserves the right, at its own expense, to assume the exclusive defense and control of any matter otherwise subject to indemnification by you. In such cases, you shall not settle any claim without Closerrr’s prior written consent.</p>
<p>(C) No Waiver of Other Remedies<br />
...
(b) any Platform downtime or error;<br />
(c) any act or omission by a Subscriber or third party;<br />
(d) any content you create, publish, or interact with on the Platform; or<br />
(e) unauthorized access, use, or alteration of your transmissions or data.</p>
<p>(B) Maximum Liability Cap<br />
To the extent Closerrr is found liable under any theory of liability, our aggregate liability to you for all claims arising out of or relating to these Terms or your use of the Platform shall not exceed the lesser of:<br />
(a) the total amount of Payouts paid to you by Closerrr in the three (3) months preceding the claim; or<br />
(b) INR 10,000 (Indian Rupees Ten Thousand only).</p>
<p>(C) Third-Party Platforms and Dependencies<br />
Closerrr expressly disclaims all liability for the acts, omissions, policies, or outages of third-party service providers, including but not limited to App Stores, cloud hosting providers, payment processors, and mobile operating systems. Your use of such services is governed solely by their respective terms and conditions.</p>
<p>(D) No Guarantee of Revenue or Results<br />
Closerrr makes no guarantee regarding the level of visibility, revenue, engagement, subscriber count, or any specific outcome resulting from your presence on the Platform. Algorithmic placement, fan discovery, and monetization are influenced by various dynamic factors outside Closerrr’s control.</p>
<p>(E) Jurisdictional Limitations<br />
...
In the event of a Force Majeure Event, Closerrr will make reasonable efforts to notify affected Creators via email, or in-app message, detailing the nature and expected duration of the disruption, where feasible.</p>
<p>(C) Suspension of Obligations<br />
During the continuation of any Force Majeure Event, Closerrr’s obligations under these Terms shall be suspended to the extent they are impacted by such event, and no breach or default shall be deemed to have occurred as a result of such suspension or delay.</p>
<p>(D) No Creator Compensation<br />
...
(b) Any attempted assignment or transfer in violation of this section shall be null, void, and constitute a material breach of these Terms.</p>
<p>(B) Platform’s Right to Assign<br />
...
(c) Any notice sent by Closerrr shall be deemed received by you upon transmission, unless Closerrr receives a delivery failure notification within 24 hours of sending.</p>
<p>(B) Service Announcements & Operational Updates<br />
(a) Closerrr may communicate changes to these Terms, updates to Platform features, policy modifications, billing cycles, or other operational information via one or more of the following means:<br />
(i) in-app notifications,<br />
(ii) banners or updates within Creator-accessible sections of the app,<br />
(iii) push notifications, or<br />
(iv) email correspondence.<br />
(b) You acknowledge and agree that continued use of the Platform after receipt of such communication shall constitute binding acceptance of the communicated change, regardless of whether you actively reviewed the content.</p>
<p>(C) Creator-Initiated Communication<br />
(a) For any matter requiring formal attention (e.g., legal disputes, account termination requests, tax documentation updates), you must initiate communication via your registered email ID to creatorcare@closerrr.com.<br />
(b) Informal outreach via social media or personal contact with Closerrr personnel will not be deemed valid or binding unless explicitly acknowledged by Closerrr in writing.</p>
...
(i) Posting the updated Terms on the official Closerrr website or within the Creator-accessible sections of the app; and<br />
(ii) Providing reasonable notice via in-app notifications, email, or other communication channels as deemed appropriate by Closerrr.</p>
<p>(B) Acceptance of Revised Terms<br />
(a) Continued access to or use of the Platform after the effective date of revised Terms shall constitute your binding acceptance of the modifications.<br />
(b) If you do not agree to the amended Terms, your sole and exclusive remedy is to discontinue your use of the Platform and request account termination in accordance with Section 15 (Account Suspension, Termination & Withdrawal).</p>
<p>(C) Platform Feature Changes<br />
(a) Closerrr retains full discretion to add, modify, restrict, or discontinue any Platform features, services, tools, or interfaces (including Creator monetization mechanisms, analytics modules, or communication features) without prior notice.<br />
(b) Such changes may occur as part of technical upgrades, performance improvements, compliance efforts, or user experience optimization.<br />
(c) You acknowledge and agree that feature availability may vary across users or regions and that no guarantee is made regarding uniform access, continuity, or visibility.</p>
<p>(D) No Obligation to Maintain Backward Compatibility<br />
...
(i) Specific reports from users or Subscribers;<br />
(ii) Platform-generated flags, suspicious activity, or fraud-detection alerts;<br />
(iii) Randomized platform-wide reviews;<br />
(iv) System integrity, moderation, or legal obligations;<br />
(v) Any other event Closerrr deems reasonably sufficient to justify a review.</p>
<p>(B) Scope of Audit<br />
(a) An audit or compliance review may include, but is not limited to:<br />
(i) A review of your published Content to ensure compliance with our Content Guidelines (Section 5 (Content Publishing & Platform Usage)) and Prohibited Conduct rules (Section 13 (Prohibited Conduct));<br />
(ii) Evaluation of interactions, messaging, Closerrr Streak data, or engagement metrics to detect manipulation or fraudulent activity;<br />
(iii) Examination of onboarding and identity verification records to ensure continued validity and consistency;<br />
(iv) Review of your financial activity, including payout tiers, active Subscriber counts, and revenue triggers;<br />
(v) Any other account usage indicators that may relate to these Terms or Applicable Law;<br />
(vi) A review of both on-platform and relevant off-platform conduct to the extent it affects user safety, reputation, or operational trust.</p>
<p>(C) Creator’s Obligation to Cooperate<br />
(a) If Closerrr initiates an audit or compliance review of your account, you agree to fully cooperate in good faith and provide all reasonably requested information.<br />
(b) This may include:<br />
(i) Verifying the originality or authorship of published Content;<br />
(ii) Confirming the validity of your identity or prior declarations;<br />
(iii) Clarifying prior messages, posts, or comments flagged in dispute;<br />
(iv) Providing an explanation of off-platform promotion tactics, if relevant;<br />
(v) Providing documents, account details, clarification responses, and any other supporting material reasonably requested.<br />
(c) Failure to respond to audit communications within the specified timelines may result in account Suspension, withholding of Payouts, or other enforcement action as described in Section 15 (Account Suspension, Termination & Withdrawal).</p>
<p>(D) Consequences of Audit Findings<br />
(a) If an audit or review confirms any violation of these Terms — including misconduct, breach of Community Guidelines, or regulatory non-compliance — Closerrr may take enforcement actions, including but not limited to:<br />
(i) Suspension or Termination of your Creator Account;<br />
(ii) Withholding or clawback of earnings for the affected revenue period(s);<br />
(iii) Downgrading of commission tier or visibility ranking;<br />
(iv) Permanent disqualification from promotional campaigns, features, or internal creator programs;<br />
(v) Legal action or referral to applicable law enforcement or regulatory bodies.<br />
(b) You will not be entitled to compensation or reimbursement for time, access restrictions, or damages arising out of any audit-related action, even if no breach is ultimately confirmed.</p>
...
(c) These rights are granted for the express purpose of marketing, advertising, and promoting the Closerrr Platform and its Services across any and all media channels, including but not limited to app store listings, social media posts, websites, press releases, case studies, and investor materials.</p>
<p>(B) No Endorsement or Paid Obligation<br />
(a) This license shall not be interpreted as an endorsement agreement or paid advertisement unless separately contracted in writing.<br />
(b) Closerrr will not make any false or misleading representation of your association or imply a commercial sponsorship arrangement without prior consent.<br />
(c) You waive any right to royalties, attribution, or additional consideration for such use unless expressly required under Applicable Law.</p>
<p>(C) Right to Opt-Out of Promotions<br />
(a) You may formally opt out of certain promotional usage of your Public Persona by writing to our support team at any time, though this may impact opportunities for feature placement or campaign inclusion.<br />
(b) Opt-out requests will only apply prospectively and will not require Closerrr to recall, remove, or delete any previously used marketing assets that have already been distributed.<br />
(c) You are encouraged to promote your Creator Account through your personal channels (e.g., other social media platforms), subject to the license and restrictions outlined in Section 19 (Intellectual Property & Trademark Usage).</p>
<p>(D) Responsible Promotional Claims<br />
(a) When promoting your Closerrr profile externally, you shall not make any false, misleading, or exaggerated claims about Platform features, Subscriber benefits, expected earnings, or platform affiliations.<br />
...
<p>(B) No Informal Modifications<br />
No oral or informal statements, guidance, or correspondence — including those from Closerrr support, onboarding staff, or internal team members — shall be deemed to modify or amend any provision of this Agreement unless formally documented and issued in writing by authorized Closerrr personnel.</p>
<p>(C) Severability<br />
...
All disputes, claims, or proceedings arising out of or relating to these Terms, including the interpretation, enforceability, or alleged breach thereof, shall be subject to the exclusive jurisdiction of the competent courts located in Bhopal, Madhya Pradesh, India. You hereby irrevocably submit to the jurisdiction of such courts and waive any objection based on improper venue or forum non conveniens.</p>
<p>(C) Right to Seek Injunctive Relief<br />
...
<p>(B) Discrepancies Between Translations<br />
(a) In the event of any inconsistency, ambiguity, or conflict between the English version and any translated version of these Terms or supplemental materials, the English version shall prevail in all respects.<br />
(b) Your continued access to and use of the Platform as a Creator is expressly conditioned upon your understanding and acceptance of the English version of these Terms.</p>
<p>(C) Creator Responsibility<br />
Creators who are not proficient in English bear sole responsibility for obtaining independent translation or legal consultation to fully understand the Terms prior to relying on or agreeing to them.</p>
`;
    ...
    <div className="bg-secondary-500 min-h-screen">
      <div className="px-4 sm:px-8 lg:px-32 py-10 sm:py-20 flex items-center flex-col w-full">
        <h1 className="text-3xl sm:text-4xl lg:text-[2.5rem] xl:text-creator-heading-lg text-center text-customPink-500 mt-10 sm:mt-20 font-hellix-bold">
          <span className="font-fredoka text-customPurple-500">Closerrr</span> Creator Terms & Conditions
        </h1>
        <div
