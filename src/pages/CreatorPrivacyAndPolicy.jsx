...
(ii) Data voluntarily transmitted via email responses and identity verification messages sent from your public Instagram or other linked social accounts, used for creator vetting, account approval, and profile activation.<br />
...
(iii) To initiate and activate your Creator account, configure profile elements, and assign you access credentials and permissions necessary to operate within the Platform.<br />
(b) Monetization, Subscription Management, and Payout Fulfilment<br />
(i) To calculate, record, and process your Payouts and commissions based on your active subscription base, applicable commission tiers, and platform engagement;<br />
(ii) To interface with integrated payment service providers, disburse your earnings, and maintain supporting metadata for audit, tax, and reconciliation purposes;<br />
(iii) To generate financial summaries, payout dashboards, and historical earnings reports for your review and internal recordkeeping.<br />
(c) Creator Tool Access, Platform Navigation, and In-App Operations<br />
(i) To enable your real-time access to creator-facing dashboards, analytics tools, messaging modules, and content upload features;<br />
(ii) To monitor and log your use of core creator functions, including Story uploads, chat engagement, Closerrr Streak activity, and participation in Closerrr Live or other interactive features;<br />
(iii) To track interface interactions, event triggers, and module activations in support of personalized functionality, content prioritization, or future product enhancements.<br />
(d) Security, Moderation, and Compliance Monitoring<br />
(i) To enforce Platform rules, monitor compliance with the Creator Terms and Conditions, and flag or review content that may be violative of policy or law;<br />
(ii) To detect impersonation, spam, content manipulation, or other abuse vectors, including story spam, suspicious subscription behaviors, or flag-triggered fan interactions;<br />
(iii) To log, escalate, and investigate backend anomalies, security threats, or usage patterns indicative of fraud, unauthorized access, or Terms violations.<br />
(e) Creator Support, Dispute Resolution, and Internal Escalation<br />
(i) To respond to creator queries, feedback, or grievance requests submitted via email or other official communication channels;<br />
(ii) To review and resolve complaints regarding payout delays, moderation actions, or feature malfunctions;<br />
(iii) To facilitate internal coordination among Closerrr’s teams (e.g., support, compliance, engineering) to address technical issues, policy clarifications, or performance escalations.<br />
(f) Product Analytics, Platform Optimization, and Service Enhancement<br />
(i) To evaluate creator usage metrics, behavioral patterns, retention rates, and content performance trends for internal analysis;<br />
(ii) To support the iterative development of creator-facing tools, interface design, pricing logic, and audience analytics modules;<br />
(iii) To conduct backend benchmarking, load testing, and functional monitoring through telemetry and aggregated diagnostic logs.<br />
(g) Regulatory Compliance, Record-Keeping, and Legal Obligations<br />
(i) To maintain records required under Applicable Law, including statutory tax records, operational audit trails, and subscription ledger data;<br />
(ii) To fulfil obligations arising under consumer protection statutes, digital commerce rules, or financial regulations applicable to Closerrr’s operations;<br />
(iii) To cooperate with lawful requests from government bodies, judicial authorities, or data protection regulators, and to disclose Creator data in accordance with due process and applicable standards.<br />
...
(b) Performance of a Contract<br />
(i) Processing activities required for the evaluation, onboarding, and ongoing operation of your Creator account, including content publishing, dashboard access, earnings calculation, and Payout fulfilment, are conducted as necessary to fulfil Closerrr’s contractual obligations to you under the Creator Terms and Conditions.<br />
(c) Compliance with Legal Obligations<br />
(i) Closerrr processes certain personal data in accordance with its obligations under tax law, corporate and financial reporting requirements, data retention mandates, and applicable consumer protection or enforcement statutes.<br />
(ii) This includes data necessary for audits, investigations, government reporting, or fulfilment of lawful directives issued by regulatory or judicial authorities.<br />
(d) Legitimate Interests<br />
...
(iii) All Processors operate under enforceable contractual terms that require confidentiality, restrict onward data transfers, and impose strict purpose limitation, security controls, and access governance.<br />
(iv) Closerrr only shares the minimum amount of Creator data required to enable the functioning of the relevant service component, consistent with the principle of data minimization.<br />
(b) Financial Institutions and Payment Platforms<br />
(i) Creator personal and financial data, such as bank account information, payout history, or commission records, may be shared with Closerrr’s payment processing partners, payout intermediaries, or financial system integrators to facilitate monthly disbursements, commission calculations, and error resolution.<br />
(ii) Such disclosures are limited to the purpose of fulfilling Closerrr’s contractual and legal obligations and are conducted in accordance with applicable payment industry standards and data protection laws.<br />
(c) Moderation, Compliance, and Audit Teams<br />
(i) Creator profile data, content uploads, or associated metadata may be reviewed by Closerrr’s internal compliance, moderation, or audit teams, or by designated external reviewers under contract, for the purpose of policy enforcement, quality assurance, content moderation, and fraud prevention.<br />
(ii) Such review activities may be triggered by automated systems (e.g., backend flags or anomaly detectors), user reports, or periodic audits conducted by Closerrr.<br />
(iii) All individuals and entities involved in such reviews are bound by confidentiality, data integrity, and access limitation obligations.<br />
(d) Governmental and Regulatory Authorities<br />
(i) Closerrr may disclose Creator personal data when required to do so by applicable law, regulatory directive, court order, or law enforcement request.<br />
(ii) Such disclosures may be made without prior notice to you, where such notice is prohibited by law or where the nature of the request requires confidentiality.<br />
(iii) Closerrr will only comply with lawful, written, and properly scoped requests for data, and shall retain audit records of such disclosures where legally permissible.<br />
(e) Business Transfers and Corporate Transactions<br />
(i) In the event of a merger, acquisition, reorganization, investment transaction, or sale of assets involving Closerrr or any of its affiliates, Creator personal data may be transferred or assigned as part of the transaction.<br />
(ii) Any successor entity shall be bound by terms no less protective than those set forth in this Policy, and all data processing shall continue to adhere to applicable privacy laws.<br />
(f) Aggregated and De-Identified Data Use<br />
(i) Closerrr may use and disclose de-identified, pseudonymized, or aggregated Creator data (which does not reveal personal identity) for research, analytics, performance modeling, or platform development.<br />
(ii) Such data shall not be used to target or affect you individually and shall not be considered “personal data” under Applicable Law.<br />
...
(iii) Closerrr may retain technical logs, content review histories, and moderation annotations in anonymized or pseudonymized form for extended periods in furtherance of platform safety and compliance tracking.<br />
(b) Legal and Regulatory Compliance<br />
(i) Certain financial and transactional data, including payout ledgers, subscription records, and revenue calculations, may be retained to comply with applicable tax, accounting, anti-fraud, and statutory audit requirements under Indian law.<br />
...
(i) You have the right to request that Closerrr correct any personal data held about you that is inaccurate, incomplete, or outdated.<br />
(ii) You may update certain information, such as your profile details and payout information, directly through official support channels or as otherwise prescribed.<br />
(c) Right to Erasure (Right to be Forgotten)<br />
(i) You may request the deletion of your personal data from Closerrr’s active systems where such data is no longer necessary for the purposes for which it was collected, or where you withdraw consent (where applicable).<br />
(ii) Closerrr may retain certain categories of data for the duration required to comply with legal, regulatory, or contractual obligations as outlined in Section 8 (Data Retention & Deletion) of this Policy.<br />
...
(iii) Creator dashboards, payout systems, and content publishing endpoints are protected through session validation, authentication controls, input sanitization, and request throttling to prevent injection, brute-force, and spoofing attacks.<br />
(iv) Closerrr conducts regular vulnerability scans, penetration tests, and system hardening exercises to monitor and enhance the technical security posture of its production environment.<br />
(b) Administrative and Organizational Safeguards<br />
(i) Access to Creator data is strictly controlled using a role-based access control (RBAC) model and is granted only to authorized employees or contractors with a verified business need.<br />
(ii) Closerrr imposes multi-layered access restrictions and time-bound credentials for personnel involved in moderation, engineering, finance, or support roles that require limited data access.<br />
(iii) All staff and service providers are contractually bound by confidentiality agreements and subject to periodic compliance training on privacy, data handling, and information security.<br />
(iv) Creator-facing support and payout communications are processed via secured, access-restricted channels with strict internal escalation policies for account-sensitive information.<br />
...
(iii) Data may be replicated or segmented across multiple zones to ensure high availability, load balancing, failover readiness, and region-based performance optimization.<br />
...
(iii) Disabling these technologies may result in partial or total loss of core Creator functionality.<br />
(b) Analytics & Diagnostic Tools<br />
(i) Closerrr integrates analytics SDKs and event tracking modules (e.g., Firebase Analytics, Amplitude, or equivalent) into the Creator dashboard to log usage metrics, session durations, dashboard engagement, payout module visits, and feature interactions.<br />
(ii) These tools generate anonymized or pseudonymized engagement profiles used to evaluate performance bottlenecks, optimize feature layout, and develop improved monetization interfaces.<br />
(iii) Diagnostic tools also capture error reports, crash logs, API call failures, and latency spikes to support infrastructure debugging and system resilience.<br />
(c) Security & Compliance Monitoring<br />
(i) Certain tracking systems monitor access patterns, content upload behavior, session frequency, and anomaly indicators for the purpose of flagging suspicious or policy-violative activity.<br />
(ii) These mechanisms are used to uphold platform integrity, enforce the Creator Terms and Conditions, and support moderation or abuse investigations.<br />
...
(b) Payment Processors & Payout Partners<br />
(i) Closerrr works with integrated payment gateways, disbursement vendors, and platform billing systems (e.g., Cashfree, or equivalent providers) to calculate, process, and settle Creator Payouts in accordance with Closerrr’s payout rules.<br />
(ii) These vendors may receive access to Creator financial metadata (e.g., bank account number, payout schedule, commission history) strictly for the purpose of transaction fulfillment, fraud prevention, or regulatory compliance.<br />
(c) Analytics & Diagnostic Platforms<br />
(i) Closerrr integrates SDKs and telemetry systems (such as Firebase, Amplitude, Sentry, or equivalent) to evaluate usage behavior, monitor feature interactions, capture system errors, and analyze creator engagement trends.<br />
(ii) These platforms may collect pseudonymized or anonymized data relating to dashboard navigation, retention patterns, or module load times. Any personal data involved is subject to Closerrr’s data minimization and contractual safeguards.<br />
(d) Communication, Support & Moderation Tools<br />
(i) Support requests, payout clarifications, and content-related moderation triggers may be processed via helpdesk platforms, notification delivery systems, or compliance interfaces managed through third-party APIs.<br />
...
(iii) Flag triggers include, but are not limited to: rapid Story deletion, repeated use of prohibited keywords, metadata anomalies, or backend policy violations.<br />
(b) Performance-Based Content Exposure<br />
(i) Closerrr may use analytics-based ranking or prioritization models to determine how Creator content is displayed in explore sections or recommendation areas.<br />
(ii) Factors used in these models may include recent activity, audience engagement, content responsiveness, or platform compliance history.<br />
...
function CreatorPrivacyAndPolicy() {
  useEffect(() => {
    document.title = "Creator Privacy Policy | Closerrr";
    return () => {
    ...
    <div className="bg-secondary-500 min-h-screen">
      <div className="px-4 sm:px-8 lg:px-32 py-10 sm:py-20 flex items-center flex-col w-full">
        <h1 className="text-3xl sm:text-4xl lg:text-[2.5rem] xl:text-creator-heading-lg text-center text-customPink-500 mt-10 sm:mt-20 font-hellix-bold">
          <span className="font-fredoka text-customPurple-500">Closerrr</span> Creator Privacy And Policy
        </h1>
        <div
...
export default CreatorPrivacyAndPolicy;
